...
(function(window){
    ...
    function lignePaginate(){
        ...
        var pageButtons = function(numberOfPage,currentPage) {
            ...
            let buttonNumberOfPage = "<input type='button' value='" + 'Página ' + currentPage + ' de ' + numberOfPage + "' disabled>";
        ...
        var addGoToPage = function(){
            let br = "<br>"
            let text = "<span>Navegar até: </span>"
            ...
            return br + text + inputBox + goButton;
        }
